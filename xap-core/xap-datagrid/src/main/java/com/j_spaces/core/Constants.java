...
public interface Constants {
    ...
    public interface CacheManager {
        ...
        String CACHE_MANAGER_BLOBSTORE_INITIL_LOAD_QUERIES_PROP = "engine.blobstore_initial_load_queries";
        String FULL_CACHE_MANAGER_BLOBSTORE_INITIL_LOAD_QUERIES_PROP = SPACE_CONFIG_PREFIX + CACHE_MANAGER_BLOBSTORE_INITIL_LOAD_QUERIES_PROP;
    ...
    public interface LeaderSelector {
        ...
        String MAX_RETRY_INTERVAL = PREFIX + "max-retry-interval";
        String MAX_RETRY_INTERVAL_DEFAULT = "10000";
        String FULL_LEADER_SELECTOR_MAX_RETRY_INTERVAL = SPACE_CONFIG_PREFIX + MAX_RETRY_INTERVAL;
        String BASE_RETRY_INTERVAL = PREFIX + "base-retry-interval";
        String BASE_RETRY_INTERVAL_DEFAULT = "100";
        String FULL_LEADER_SELECTOR_BASE_RETRY_INTERVAL = SPACE_CONFIG_PREFIX + BASE_RETRY_INTERVAL;

...
/**
 * Created by yechiel on 2/28/17.
 */
/*
extention for evictable entry in layered storage
 */
public class EvictableLayeredStorageEntryHolder extends EntryHolder {

    public EvictableLayeredStorageEntryHolder(IServerTypeDesc typeDesc, String uid, long scn,
    ...
    public EvictableLayeredStorageEntryHolder(IEntryHolder other) {
        super(other);
        ;
    }
